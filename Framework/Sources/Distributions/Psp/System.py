...
def install(base_path, build_path, output_path, args):
    print("Todo this distribution is not yet implemented.")
    #print("Installing...")
...
def build(base_path, build_path, output_path, args):
    ...
    os.makedirs(os.path.join(output_path, "lib"), exist_ok=True)
    shutil.move(os.path.join(build_path, "particule.a"), os.path.join(output_path, "lib", "particule.a"))
